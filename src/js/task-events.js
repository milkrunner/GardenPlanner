...
GartenPlaner.prototype.handleDragEnd = function(e) {
...
GartenPlaner.prototype.handleDragOver = function(e) {
    if (e.preventDefault) {
        e.preventDefault();
    }
...
GartenPlaner.prototype.handleDragEnter = function(e) {
    if (e.currentTarget.classList.contains('task-card')) {
        e.currentTarget.classList.add('drag-over');
    }
};

GartenPlaner.prototype.handleDragLeave = function(e) {
    if (e.currentTarget.classList.contains('task-card')) {
